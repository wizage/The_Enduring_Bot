...
export abstract class FashionSlash {
  ...
  @SlashOption({
    ...
    const ownerSubmission = new EmbedBuilder()
      ...
      .addFields([{ name:'In-game name', value:username, inline: true }, { name: 'Title', value:fashionTitle ? fashionTitle : 'N/A', inline: true }])
    ...
    if (interaction.guildId === '932144876659822623') {
      ...
      ownerChannelId = '1154455826644353066'; //tbd
    }
